...
// MVP hubs: CAISO, MISO, NYISO, SPP, ERCOT.
// PJM skipped (requires paid membership for data redistribution).
// ISONE skipped (requires paid membership).
export const HUBS: HubConfig[] = [
  ...
  { hub: "SPP_SOUTH", dataset: "spp_lmp_real_time_5_min", location: "SPPSOUTH_HUB", priceField: "lmp", isDayAhead: false, maxLagHours: 1 },
];
